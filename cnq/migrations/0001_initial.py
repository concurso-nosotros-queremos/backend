# Generated by Django 2.2.1 on 2019-07-25 15:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inscription_date_from', models.DateTimeField(verbose_name='Insc_Desde')),
                ('inscription_date_to', models.DateTimeField(verbose_name='Insc_Hasta')),
            ],
        ),
        migrations.CreateModel(
            name='Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=40, verbose_name='Direccion')),
                ('principal_name', models.CharField(max_length=25, verbose_name='Nombre del director')),
                ...
                ('com_preference', models.IntegerField(choices=[(0, 'Telefonica'), (1, 'Email'), (2, 'Otro')], verbose_name='Preferencia de la comunicacion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=30, null=True, verbose_name='Telefono')),
                ('grade_choices', models.IntegerField(choices=[(0, '4to'), (1, '5to'), (2, '6to'), (3, '7mo')], verbose_name='Año')),
                ('divition_choices', models.IntegerField(choices=[(0, 'A'), (1, 'B'), (2, 'C')], verbose_name='Division')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('street_name', models.CharField(max_length=35, verbose_name='Direccion')),
                ('street_number', models.CharField(max_length=10, verbose_name='Altura')),
                ...
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='group_location', to='cnq.Group')),
            ],
        ),
        migrations.CreateModel(
            name='ContestWinner',
