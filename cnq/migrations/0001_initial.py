# Generated by Django 2.2.3 on 2019-11-25 12:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token', models.CharField(max_length=7, unique=True, verbose_name='Token')),
                ('is_active', models.BooleanField(default=True, verbose_name='Activo')),
                ('max_uses', models.PositiveIntegerField(null=True, verbose_name='Usos maximos')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group', to='cnq.Group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.CharField(max_length=240, verbose_name='Mensaje')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_types', models.PositiveIntegerField(choices=[(0, 'Publica'), (1, 'Privada'), (2, 'Tecnica Publica'), (3, 'Tecnica Privada'), (4, 'Escuela Rural'), (5, 'Residencia')], validators=[django.core.validators.MinValueValidator(0)], verbose_name='Tipo de escuela')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diffusion', models.PositiveIntegerField(choices=[(0, 'Mail'), (1, 'Afiches del concurso'), (2, 'Redes Sociales'), (3, 'Medios de comunicacion tradicionales'), (4, 'He participado en años anteriores')], validators=[django.core.validators.MaxValueValidator(4), django.core.validators.MinValueValidator(0)], verbose_name='Difusion')),
