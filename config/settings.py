...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'context_prohttps://github.com/concurso-nosotros-queremos/backend.gitcessors': [
                'django.https://github.com/concurso-nosotros-queremos/backend.gittemplate.context_processors.debug',
                'django.https://github.com/concurso-nosotros-queremos/backend.gittemplate.context_processors.request',
                'django.https://github.com/concurso-nosotros-queremos/backend.gitcontrib.auth.context_processors.auth',
